...
<body>
        ...
        <div class="row">
            ...
            <div class="mb-3">
                ...
                <div class="container">
                    <h1 class="mt-5 mb-5">Avis clients</h1>
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-4 text-center">
                                    <h3 class="mt-4 mb-3">Laissez nous un avis</h3>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <textarea name="user_review" id="user_review" class="form-control" placeholder="Laissez un avis"></textarea>
                </div>
